...
@Mixin(targets = "tamaized.voidscape.event.EtherealPlantGenerator", remap = false)
public abstract class EtherealPlantGeneratorMixin {
    @WrapOperation(
            method = "*",
            at = @At(
                    value = "INVOKE",
    ...
    private boolean dimblend$keepFruitInVoidscapeLane(
            Level level,
            BlockPos pos,
            BlockState state,
